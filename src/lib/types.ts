...
export interface AppSettings{platformMode:"auto"|"mac"|"windows";targetAppMac:string;targetProcessWindows:string;nameTemplate:string;fps:number;fpsConfirmed:boolean;shortcutsMac:ShortcutMap;shortcutsWindows:ShortcutMap}
